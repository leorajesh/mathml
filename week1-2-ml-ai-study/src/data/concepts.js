...
const baseConcepts = [
  {
    ...
    prerequisites: [],
    followOns: ['sets', 'feature-vectors', 'linear-classifier', 'linear-regression', 'model-complexity-generalization'],
  ...
  },
  {
    ...
    formulas: [
      ...
      {
        tex: tex`\theta \cdot x = \theta^T x = \sum_{i=1}^{d} \theta_i x_i = \lVert\theta\rVert\,\lVert x\rVert\cos\varphi`,
        definitions: [tex`\theta_i: weight on feature i`, tex`\theta \cdot x: model score before thresholding or transformation`, tex`\varphi: angle between theta and x; the score is positive when the angle is under 90 degrees`, tex`\lVert x\rVert: length of x, the square root of x dot x`],
      },
    ],
    example: ['Let x = [2, 3] and theta = [4, -1].', 'theta dot x = 4*2 + (-1)*3 = 8 - 3 = 5.', 'If a classifier uses sign(theta dot x), this example lands on the positive side.', 'Geometrically, ||x|| = sqrt(13) and ||theta|| = sqrt(17), so cos(angle) = 5 / sqrt(221) = 0.336 and the angle is about 70 degrees: less than 90, hence the positive score.'],
    ...
    prerequisites: ['ml-workflow', 'sets'],
  ...
  },
  {
    ...
    prerequisites: ['feature-vectors', 'basis-coordinates'],
  ...
  },
  {
    ...
    prerequisites: ['feature-vectors', 'gradient-descent-method'],
