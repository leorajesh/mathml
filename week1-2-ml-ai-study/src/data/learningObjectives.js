export const learningObjectives = [
  {
    ...
    items: [
      ...
      { objective: 'Identify the essential components of an ML model: data, features, hypothesis class, loss, optimization, and generalization.', concepts: ['ml-workflow', 'feature-vectors', 'model-complexity-generalization'], check: 'Given a new task, can you name the input, output, model family, loss, and optimizer?' },
  ...
  },
  {
    ...
    items: [
      ...
      { objective: 'Compare hinge loss with 0-1 loss.', concepts: ['empirical-risk-zero-one', 'hinge-loss', 'convexity-surrogate-losses'], check: 'Why can a correct prediction still have positive hinge loss?' },
    ],
  },
  {
    area: 'Gradient Descent, Linear Regression, and Ridge Regression',
    items: [
      { objective: 'Check convexity and explain why convex objectives are easier to optimize.', concepts: ['convexity-surrogate-losses', 'gradient-descent'], check: 'Which convexity test would you use for a twice-differentiable one-variable function?' },
      { objective: 'Implement stochastic (sub-)gradient descent conceptually.', concepts: ['stochastic-subgradient-descent', 'gradient-descent'], check: 'How does the hinge-loss SSGD update differ from perceptron?' },
  ...
  },
  {
    ...
    items: [
      { objective: 'Use sets, set operations, functions, inverses, and composition.', concepts: ['sets-functions', 'composition-of-transformations'], check: 'What extra properties does a function need before an inverse exists?' },
      ...
      { objective: 'Use Gaussian elimination, REF, and RREF to solve systems and test independence.', concepts: ['gaussian-elimination', 'solution-structure', 'linear-independence-subspaces'], check: 'What do pivot and free columns tell you?' },
      { objective: 'Understand vector spaces, linear combinations, bases, dimension, and subspaces.', concepts: ['vector-spaces-bases', 'linear-independence-subspaces'], check: 'Why does a basis make coordinates unique?' },
      ...
      { objective: 'Find inverses, rank, nullity, and determinants, including cofactor and row-operation methods.', concepts: ['rank-inverse-determinant', 'determinants-cofactor-row-ops', 'invertible-transformations'], check: 'Which row operations change a determinant, and how?' },
    ],
  },
];
