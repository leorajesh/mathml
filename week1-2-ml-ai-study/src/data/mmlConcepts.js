...
export const mmlConcepts = [
  ...
  },
  {
    ...
    formulas: [
      ...
      { tex: tex`g(x)\le0:\qquad \lambda\ge0,\qquad \lambda\,g(x^*)=0`, definitions: [tex`g: inequality constraint function`, 'complementary slackness: the last condition; either the constraint is active or its multiplier is zero'] },
    ],
