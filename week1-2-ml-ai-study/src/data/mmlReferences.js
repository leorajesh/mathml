...
export const mmlReferences = {
  ...
  'exp-log': [ref('6.6', 'Conjugacy and the Exponential Family (the sigmoid)', 213), ref('8.3.1', 'Maximum Likelihood Estimation (negative log-likelihood)', 265)],
  'probability-basics': [ref('6.1', 'Construction of a Probability Space', 172), ref('6.3', 'Sum Rule, Product Rule, and Bayes\' Theorem', 183), ref('6.4.5', 'Statistical Independence', 194)],
  'expectation-variance': [ref('6.4.1', 'Means and Covariances', 187), ref('6.4.2', 'Empirical Means and Covariances', 191), ref('6.4.3', 'Three Expressions for the Variance', 192)],
  'covariance-gaussian': [ref('6.4.1', 'Means and Covariances (covariance and correlation)', 187), ref('6.4.4', 'Sums and Transformations of Random Variables', 193), ref('6.5', 'Gaussian Distribution', 197)],
  'likelihood-mle': [ref('8.3.1', 'Maximum Likelihood Estimation', 265), ref('6.6.1', 'Conjugacy (Example 6.8, the Bernoulli distribution)', 205)],
