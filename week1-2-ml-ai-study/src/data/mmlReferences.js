...
export const mmlReferences = {
  ...
  'covariance-gaussian': [ref('6.4.1', 'Means and Covariances (covariance and correlation)', 187), ref('6.4.4', 'Sums and Transformations of Random Variables', 193), ref('6.5', 'Gaussian Distribution', 197), ref('6.5.3', 'Sums and Linear Transformations', 201)],
  'likelihood-mle': [ref('8.3.1', 'Maximum Likelihood Estimation', 265), ref('6.6', 'Conjugacy and the Exponential Family (Example 6.8, the Bernoulli distribution)', 205)],
