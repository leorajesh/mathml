...
export const quizzes = {
  ...
  "linear-regression": [
    ...
    {"question": "When does early stopping end gradient descent in the Lesson 3 procedure?", "answer": "When the parameters change by less than a small threshold delta, or after a maximum number of iterations", "wrong": ["As soon as the loss increases once", "When the loss reaches exactly zero", "After one pass over the data"], "why": "Tiny changes mean the parameters have settled; the iteration cap guards against running forever."},
  ],
