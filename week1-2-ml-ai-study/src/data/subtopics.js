...
export const topics = [
  ...
  },
  {
    ...
    summary: 'Minimizing a loss by repeated downhill steps: with smooth slopes, at sharp corners, and one random example at a time.',
    overview: 'Gradient descent steps against the slope of a smooth loss. Subgradients extend the idea to losses with corners, such as hinge loss and absolute value. Stochastic subgradient descent makes each step cheap by using one random example.',
    children: ['gradient-descent-method', 'subgradients', 'stochastic-subgradient-descent'],
  },
  {
...
export const subtopicConcepts = [
  ...
  },
  {
    ...
    followOns: ['model-complexity-generalization', 'eigenvalues-eigenvectors', 'svd'],
    sources: ['W1C2.pdf', 'W2C1.pdf'],
  },
  ...
  // ---------- Rank, nullity, determinants ----------
  {
    ...
    followOns: ['determinant-geometry', 'invertible-transformations', 'least-squares-normal-equation'],
    sources: ['W2C1.pdf'],
  },
  {
  ...
  // ---------- Convexity, surrogate losses ----------
  {
    ...
    prerequisites: ['empirical-risk-zero-one'],
  ...
  // ---------- Gradient and subgradient descent ----------
  {
    ...
    followOns: ['subgradients', 'stochastic-subgradient-descent', 'linear-regression', 'logistic-loss'],
  ...
  // ---------- Lasso, elastic net ----------
  {
    ...
    prerequisites: ['ridge-regularization', 'subgradients'],
  ...
  },
  {
    ...
    followOns: ['cholesky-decomposition', 'svd'],
    sources: ['W3C2.pdf'],
  },
  ...
  },
  {
    ...
    graph: { type: 'decomposition', title: 'SVD as rotate, scale, rotate', caption: 'The square centred at the origin is first rotated by V^T, then stretched along the axes, then rotated by W. The singular values are the two stretches, listed from largest to smallest.', sliders: [{ key: 'sigma1', label: 'stretch along axis 1', min: 0.2, max: 3, step: 0.1, value: 2.4 }, { key: 'sigma2', label: 'stretch along axis 2', min: 0.2, max: 3, step: 0.1, value: 0.9 }, { key: 'rotationV', label: 'first rotation (V^T)', min: 0, max: 180, step: 5, value: 0 }, { key: 'rotation', label: 'second rotation (W)', min: 0, max: 180, step: 5, value: 30 }] },
    ...
    followOns: ['dimensionality-reduction'],
    sources: ['W3C2.pdf'],
  },
];
